			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="loginUsername" name="loginUsername" type="text" placeholder="e.g. anuragLimbu" value="<?php getInputValue('loginUsername') ?>" required>
					</p>
					<p>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="username" name="username" type="text" placeholder="e.g. anuragLimbu" value="<?php getInputValue('username') ?>" required>
					</p>
